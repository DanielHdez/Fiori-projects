			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dhlinvoices-display": {
								"semanticObject": "dhlinvoices",
								"action": "display",
								"description": "This is an application to manage invoices",
								"title": " Invoices Management",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dhl.invoices",
									"url": sap.ui.require.toUrl("dhl/invoices")
								}
							}
						}
					}
